...
class EEInfoController(CementBaseController):
    ...
    def info_php(self):
        ...
        version = os.popen("{0} -v 2>/dev/null | head -n1 | cut -d' ' -f2 |".format("php5.6" if (EEVariables.ee_platform_codename == 'trusty' or EEVariables.ee_platform_codename == 'xenial' or EEVariables.ee_platform_codename == 'bionic' or EEVariables.ee_platform_codename == 'stretch' or EEVariables.ee_platform_codename == 'buster' or EEVariables.ee_platform_codename == 'bullseye') else "php") +
                           " cut -d'+' -f1 | tr -d '\n'").read
        config = configparser.ConfigParser()
        config.read('/etc/{0}/fpm/php.ini'.format("php/5.6" if (EEVariables.ee_platform_codename == 'trusty' or EEVariables.ee_platform_codename == 'xenial' or EEVariables.ee_platform_codename == 'bionic' or EEVariables.ee_platform_codename == 'stretch' or EEVariables.ee_platform_codename == 'buster' or EEVariables.ee_platform_codename == 'bullseye') else "php5"))
        ...
        config.read('/etc/{0}/fpm/pool.d/www.conf'.format("php/5.6" if (EEVariables.ee_platform_codename == 'trusty' or EEVariables.ee_platform_codename == 'xenial' or EEVariables.ee_platform_codename == 'bionic' or EEVariables.ee_platform_codename == 'stretch' or EEVariables.ee_platform_codename == 'buster' or EEVariables.ee_platform_codename == 'bullseye') else "php5"))
        ...
        config.read('/etc/{0}/fpm/pool.d/debug.conf'.format("php/5.6" if (EEVariables.ee_platform_codename == 'trusty' or EEVariables.ee_platform_codename == 'xenial' or EEVariables.ee_platform_codename == 'bionic' or EEVariables.ee_platform_codename == 'stretch' or EEVariables.ee_platform_codename == 'buster' or EEVariables.ee_platform_codename == 'bullseye') else "php5"))
